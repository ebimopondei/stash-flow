...
app.use(cors(
    { 
        origin: ["http://localhost:5173", "https://stash-flow-frontend.vercel.app/", "http://localhost:5174", "http://localhost:3000", "http://localhost:4173", 'http://192.168.0.102:5173', 'http://192.168.174.172:4173',  "http://10.0.12.7:5173", "http://10.0.12.7:4173"], 
